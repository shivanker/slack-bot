...
class OpenAIChatCompletionsModel(Model):
    ...
    def _non_null_or_none(self, value: Any) -> Any:
        return value
    ...
    async def stream_response(
        ...
        final_response = fake_response.model_copy()
    ...
    async def _fetch_response(
    ...
    ) -> Union[LitellmModelResponse, CustomStreamWrapper]:
        ...
        ret = await litellm.acompletion(
            ...
            temperature=self._non_null_or_none(model_settings.temperature),
            top_p=self._non_null_or_none(model_settings.top_p),
            frequency_penalty=self._non_null_or_none(model_settings.frequency_penalty),
            presence_penalty=self._non_null_or_none(model_settings.presence_penalty),
            max_tokens=self._non_null_or_none(model_settings.max_tokens),
            tool_choice=tool_choice,
            ...
            store=store,
            reasoning_effort=self._non_null_or_none(reasoning_effort),
