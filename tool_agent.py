...
from haystack.components.builders import PromptBuilder, DynamicChatPromptBuilder  # type: ignore
...
class OutputValidator:
    ...
    def run(self, replies: List[ChatMessage]):
        ...
        logger.info("Got message from LLM: %s", replies[0])
...
generator = OpenAIChatGenerator(model="gpt-4-turbo")
